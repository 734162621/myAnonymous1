...
##### Submission 5174 to NeurIPS 2025
...
1. Macro decision-making and Micro operation available;
2. Multi-Agent(even heterogeneous agent) collaboration, point-to-point communication, domain communication;
3. Rich experimental tasks, consist of 24 llm_pysc2 experiments with 9 llm_smac tasks (more to be added);
4. Support for parallel experiments, multi-agent multi-thread concurrently query;
5. Diversified observational information, text observation, feature maps and StarCraft2 wiki data;
6. Complete StarCraft2 action space, with support for nearly all kinds of unit skills/abilities;
7. Automatic economic management in complete game;
8. High quality logger and data recorder.
...
We provided complete game and two series of experiment tasks for micro-operations: 

```
(1) complete games: run llm_pysc2/bin/experiment_full_game.py, start a complete game in Simple64 map
```
